...
<article class="baking cooking">
    <div>
        ...
        <h2>Maple Glazed Salmon</h2>
        <figure>
            <img alt="Pic of salmon" src="../images/salmon.jpg">
        </figure>
        <p><b>Ingredients:</b></p>
        <ol>
            <li>6-12oz salmon filet </li>
        ...
        <p>
            Begin by preparing rice. While it's cooking, preheat oven to 400 degrees. If the salmon filet is large, cut in half or in thirds.
            Line a baking pan with aluminum foil or parchment paper. Place the salmon on the pan
            and coat with half of the maple syrup. Bake for 15 minutes, then briefly remove to 
            re-coat with the rest of the maple syrup. Bake for an additional 5-10 minutes, depending
            on the thickness of the salmon.
        </p>
        <p>
            Chop desired amount of kale if not already done so. In a pan over medium heat, add water,
            oil, and kale. Cover. Remove cover after a few minutes, sautee until kale is soft. Add salt and pepper to tase.
        </p>
         <p>
            Serve salmon and kale over rice.
        </p>
        <h3>By Blake Williams. December 02, 2017</h3>
    </div>
    ...
    <div>
        ...
        <figure>
            <img alt="Pic of fajita" src="../images/fajita.jpg">
        </figure>
        <p><b>Ingredients:</b></p>
        <ol>
            ...
            <li>taco/fajita seasoning mix </li>
            <li>tortillas </li>
            <li>shredded cheese </li>
            <li>lettuce </li>
        </ol>
        <p>
            Begin by slicing the chicken into small pieces. Place half of the olive oil
            in a pan and heat over medium-high heat. Place the chicken in the pan and sprinkled
            the taco or fajita seasoning over it. Stir occasionally.
        </p>
        <p>
            Cut up a bell pepper and add to the pan after about 5-10 minutes. Add the second half of the
            olive oil. Keep stirring the pan periodically. Cook until chicken is thoroughly cooked, about 20 minutes.
        </p>
         <p>
            Heat up the tortillas in the pan for about a minute per side or microwave for under a minute.
            Add the chicken and peppers to the fajitas, and top with shredded lettuce, cheese, and any additionally
            toppings you may prefer.
        </p>
        <h3>By Blake Williams. December 01, 2017</h3>
    </div>
